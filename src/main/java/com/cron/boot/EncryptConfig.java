...
/**
 * Created by song.yang on 2017/3/30：19:47.
 * <p>
 * e-mail:song.yang@msxf.com
 */
@Configuration
@ConditionalOnClass(StringEncryptor.class)
@PropertySource(value = { "${encrypt.file:classpath:config/config.properties}", "${remote.file:classpath:config/remote.properties}"})
public class EncryptConfig implements EnvironmentAware {
    ...
    private StringEncryptor stringEncryptor() {
        ...
        config.setPassword(getProperty(environment, "jasypt.encryptor.password", "msxf2016"));
